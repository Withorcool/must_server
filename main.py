...
print("""
 ____ ____ ____ ____ ____ _________ ____ ____ ____ ____ ____ ____ ____ _________ ____ ____ ____ ____ ____ 
||S |||m |||i |||l |||e |||       |||S |||t |||u |||d |||i |||o |||s |||       |||g |||a |||m |||e |||s ||
...
def handle_messages(identifier: str):
    ...
    print(f"Игрок {username} с ID {identifier} покинул игру...")
...
def main():
    ...
    while True:
        ...
        print(f"Сесиия открыта {addr}, ID сесии: {new_id}...")
